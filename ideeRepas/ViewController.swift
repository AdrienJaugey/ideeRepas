...
class ViewController: UIViewController, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        //Màj automatique des images si changement de thème de couleur (sombre/clair)
